...
import { ArrowRight, MousePointerClick, Target, BarChart, MessageSquare, Zap, Building, Home, Sun, Stethoscope, Wrench, ShoppingBag, ShoppingCart, Facebook, TrendingUp, Gauge, Users, Monitor } from "lucide-react";
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center bg-gradient-to-br from-[#03173B] to-[#093383] overflow-hidden">
        ...
        <div className="container relative z-10 px-4 text-center">
          <div className="inline-block animate-fade-in" style={{
          animationDelay: "0.2s"
        }}>
          ...
          <h1 className="mt-6 text-4xl md:text-6xl font-bold text-white max-w-4xl mx-auto leading-tight">
            <span ref={el => textElements.current[0] = el} className="block mb-2">Un seul objectif</span>
            <span ref={el => textElements.current[1] = el} className="block text-3xl md:text-6xl">DES LEADS</span>
          </h1>
          <p className="mt-6 text-xl text-white/80 max-w-2xl mx-auto animate-fade-in" style={{
          animationDelay: "0.8s"
        }}>Qualité, Quantité, Compétitivité </p>
        ...
        <div className="container">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative aspect-video rounded-xl overflow-hidden shadow-2xl">
              <iframe src="https://player.vimeo.com/video/1094103975?h=f4a439f1f7&amp;title=0&amp;byline=0&amp;portrait=0&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" className="w-full h-full" frameBorder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" title="Agence Goodleft" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container">
          <SectionHeading title="Des résultats concrets" subtitle="Nous aidons les entreprises du bâtiment à se développer grâce à des stratégies marketing performantes." centered chip="Nos chiffres" />

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <StatCard icon={<BarChart className="h-6 w-6" />} value="2M€+" label="Budget d'ads sous gestion" />
            <StatCard icon={<Users className="h-6 w-6" />} value="47" label="Clients satisfaits" />
            <StatCard icon={<MousePointerClick className="h-6 w-6" />} value="600 000+" label="Leads générés" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container">
          <SectionHeading title="Nos domaines d'expertise" subtitle="Nous offrons une gamme complète de services marketing digital adaptés au secteur du bâtiment." centered chip="Services" />

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ServiceCard icon={<Facebook className="h-6 w-6" />} title="Meta Ads" description="Campagnes Facebook et Instagram optimisées pour générer des leads qualifiés." link="/services#metaads" delay={100} />
      ...
      <section className="py-20 bg-gray-50">
        <div className="container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <IndustryCard name="Dépannage" icon={<Wrench className="h-5 w-5" />} delay={300} />
            <IndustryCard name="Vêtements" icon={<ShoppingBag className="h-5 w-5" />} delay={350} />
            <IndustryCard name="E-commerce" icon={<ShoppingCart className="h-5 w-5" />} delay={400} />
            <IndustryCard name="Croissance" icon={<TrendingUp className="h-5 w-5" />} delay={450} />
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container">
          <SectionHeading title="Notre approche" subtitle="Un processus structuré pour assurer les meilleurs résultats pour votre entreprise." centered chip="Méthodologie" />
          ...
          <div className="relative mt-16">
            ...
            <div className="space-y-12 md:space-y-0">
              {processSteps.map((step, index) => <div key={index} className={`relative ${index % 2 === 0 ? "md:pl-12 md:pr-0 md:ml-auto md:mr-[50%]" : "md:pr-12 md:pl-0 md:mr-auto md:ml-[50%]"} pl-16 reveal`}>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container">
          <SectionHeading title="Ce que nos clients disent" subtitle="Découvrez les retours de nos clients satisfaits par notre approche et nos résultats." centered chip="Témoignages" />

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <TestimonialCard quote="Toujours au top. Les leads sont qualifiés et le suivi est impeccable. Un grand merci à Lior pour son accompagnement personnalisé !" author="David T." delay={100} />
            <TestimonialCard quote="Sérieux et disponible. L'équipe répond rapidement à nos questions et nous guide efficacement dans nos campagnes." author="John L." delay={200} />
            <TestimonialCard quote="Je recommande fortement cette agence. Résultats au rendez-vous et expertise reconnue. Un grand merci à Lior pour sa réactivité !" author="David S." delay={300} />
            <TestimonialCard quote="Très bon investissement ! Notre ROI a considérablement augmenté depuis le début de notre collaboration." author="Jerome" delay={400} />
          </div>
        </div>
      </section>

      {/* CTA Section */}
      <CTASection title="Prêt à booster votre présence en ligne ?" description="Contactez-nous dès aujourd'hui pour discuter de votre projet et découvrir comment nous pouvons vous aider à générer plus de leads et développer votre entreprise." buttonText="Démarrer votre projet" buttonLink="/contact" />
